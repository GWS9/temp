...
cmd:option('-print_every',10,'how many steps/minibatches between printing out the loss') -- orig 1
cmd:option('-eval_val_every',10000,'every how many iterations should we evaluate on validation data?') --orig 1000
